...
exports.run = (client, message, args) => {
  var btcPrice = getJSON('https://api.coinmarketcap.com/v1/ticker/monero/', function(error, response){
		if(!error) {
      var xmrPrice = response[0]["price_usd"];
      ...
      const embed = new Discord.RichEmbed()
        ...
        .setDescription(":ledger: Maple Change XMR Market Data:")
        .setFooter(miscSettings.footerBranding, miscSettings.img32x32)
        .setThumbnail(miscSettings.imgXMR)
        /*
         * Takes a Date object, defaults to current date.
         */
        .setTimestamp()
        .setURL("https://github.com/TeamEGEM/maplebot")
        .addField("Website:", "https://monero.org/")
        .addField("Price", xmrPrice+" USD")
