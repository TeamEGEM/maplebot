...
exports.run = (client, message, args) => {
  var btcPrice = getJSON('https://maplechange.com/api/v2/tickers/xlnbtc.json', function(error, response){
		if(!error) {
      ...
      const embed = new Discord.RichEmbed()
        ...
        .setDescription(":ledger: Maple Change XLN Market Data:")
        .setFooter(miscSettings.footerBranding, miscSettings.img32x32)
        .setThumbnail(miscSettings.imgXLN)
        /*
        ...
        .addField("Bitcoin Pair", "[BTC/XLN :scales:](https://maplechange.com/markets/xlnbtc)", true)
        .addField("Litecoin Pair", "[LTC/XLN :scales:](https://maplechange.com/markets/xlnltc)", true)
        .addField("Ethereum Pair", "[LTC/XLN :scales:](https://maplechange.com/markets/xlneth)", true)
        .addField("WeyCoin Pair", "[WAE/XLN :scales:](https://maplechange.com/markets/xlnwae)", true)
