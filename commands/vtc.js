...
exports.run = (client, message, args) => {
  var btcPrice = getJSON('https://api.coinmarketcap.com/v1/ticker/vertcoin/', function(error, response){
		if(!error) {
      var vtcPrice = response[0]["price_usd"];
      ...
      const embed = new Discord.RichEmbed()
        ...
        .setDescription(":ledger: Maple Change VTC Market Data:")
        .setFooter(miscSettings.footerBranding, miscSettings.img32x32)
        .setThumbnail(miscSettings.imgVTC)
        /*
         * Takes a Date object, defaults to current date.
         */
        .setTimestamp()
        .setURL("https://github.com/TeamEGEM/maplebot")
        .addField("Website:", "https://vertcoin.org/")
        .addField("Price", vtcPrice+" USD")
