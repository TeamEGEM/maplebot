...
exports.run = (client, message, args) => {
  var btcPrice = getJSON('https://maplechange.com/api/v2/tickers/civbtc.json', function(error, response){
		if(!error) {
      ...
      const embed = new Discord.RichEmbed()
        ...
        .setDescription(":ledger: Maple Change CIV Market Data:")
        .setFooter(miscSettings.footerBranding, miscSettings.img32x32)
        .setThumbnail(miscSettings.imgCIV)
        /*
        ...
        .addField("Bitcoin Pair", "[BTC/CIV :scales:](https://maplechange.com/markets/civbtc)", true)
        .addField("Litecoin Pair", "[LTC/CIV :scales:](https://maplechange.com/markets/civltc)", true)
        .addField("Ethereum Pair", "[ETH/CIV :scales:](https://maplechange.com/markets/civeth)", true)
        .addField("WeyCoin Pair", "[WAE/CIV :scales:](https://maplechange.com/markets/civwae)", true)
