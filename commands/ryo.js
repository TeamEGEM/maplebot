...
exports.run = (client, message, args) => {
  var btcPrice = getJSON('https://maplechange.com/api/v2/tickers/ryobtc.json', function(error, response){
		if(!error) {
      ...
      const embed = new Discord.RichEmbed()
        ...
        .setDescription(":ledger: Maple Change RYO Market Data:")
        ...
        .addField("Website:", "https://ryo-currency.com/")
        ...
        .addField("Bitcoin Pair", "[BTC/RYO :scales:](https://maplechange.com/markets/ryobtc)", true)
        .addField("Litecoin Pair", "[LTC/RYO :scales:](https://maplechange.com/markets/ryoltc)", true)
        .addField("Ethereum Pair", "[ETH/RYO :scales:](https://maplechange.com/markets/ryoeth)", true)
        .addField("WeyCoin Pair", "[WAE/RYO :scales:](https://maplechange.com/markets/ryowae)", true)
