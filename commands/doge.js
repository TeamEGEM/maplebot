...
exports.run = (client, message, args) => {
  var btcPrice = getJSON('https://api.coinmarketcap.com/v1/ticker/dogecoin/', function(error, response){
		if(!error) {
      var dogePrice = response[0]["price_usd"];
      ...
      const embed = new Discord.RichEmbed()
        ...
        .setDescription(":ledger: Maple Change DOGE Market Data:")
        .setFooter(miscSettings.footerBranding, miscSettings.img32x32)
        .setThumbnail(miscSettings.imgDOGE)
        /*
         * Takes a Date object, defaults to current date.
         */
        .setTimestamp()
        .setURL("https://github.com/TeamEGEM/maplebot")
        .addField("Website:", "https://dogecoin.com/")
        .addField("Price", dogePrice+" USD")
