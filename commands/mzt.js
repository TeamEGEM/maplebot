...
exports.run = (client, message, args) => {
  var btcPrice = getJSON('https://maplechange.com/api/v2/tickers/mztbtc.json', function(error, response){
		if(!error) {
      ...
      const embed = new Discord.RichEmbed()
        ...
        .setDescription(":ledger: Maple Change MZT Market Data:")
        ...
        .addField("Website", "https://myztic.cash/")
        ...
        .addField("Bitcoin Pair", "[BTC/MZT :scales:](https://maplechange.com/markets/mztbtc)", true)
        .addField("Litecoin Pair", "[LTC/MZT :scales:](https://maplechange.com/markets/mztltc)", true)
        .addField("Ethereum Pair", "[ETH/MZT :scales:](https://maplechange.com/markets/mzteth)", true)
        .addField("WeyCoin Pair", "[WAE/MZT :scales:](https://maplechange.com/markets/mztwae)", true)
