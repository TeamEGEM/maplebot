...
exports.run = (client, message, args) => {
  var btcPrice = getJSON('https://maplechange.com/api/v2/tickers/grwibtc.json', function(error, response){
		if(!error) {
      ...
      const embed = new Discord.RichEmbed()
        ...
        .setThumbnail(miscSettings.imgGRWI)
        /*
        ...
        .addField("Bitcoin Pair", "[BTC/GZRO :scales:](https://maplechange.com/markets/grwibtc)", true)
