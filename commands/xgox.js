...
exports.run = (client, message, args) => {
  var btcPrice = getJSON('https://maplechange.com/api/v2/tickers/xgoxbtc.json', function(error, response){
		if(!error) {
      ...
      const embed = new Discord.RichEmbed()
        ...
        .setDescription(":ledger: Maple Change XGOX Market Data:")
        .setFooter(miscSettings.footerBranding, miscSettings.img32x32)
        .setThumbnail(miscSettings.imgXGOX)
        /*
        ...
        .addField("Bitcoin Pair", "[BTC/XGOX :scales:](https://maplechange.com/markets/xgoxbtc)", true)
        .addField("Litecoin Pair", "[LTC/XGOX :scales:](https://maplechange.com/markets/xgoxltc)", true)
        .addField("Ethereum Pair", "[ETH/XGOX :scales:](https://maplechange.com/markets/xgoxeth)", true)
        .addField("WeyCoin Pair", "[WAE/XGOX :scales:](https://maplechange.com/markets/xgoxwae)", true)
