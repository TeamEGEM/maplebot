...
exports.run = (client, message, args) => {
  var btcPrice = getJSON('https://maplechange.com/api/v2/tickers/mribtc.json', function(error, response){
      ...
      const embed = new Discord.RichEmbed()
        ...
        .addField("WeyCoin Pair", "[ETH/MRI :scales:](https://maplechange.com/markets/mrieth)", true)
        .addField("Ethereum Pair", "[XGOX/MRI :scales:](https://maplechange.com/markets/xgoxmri)", true)
