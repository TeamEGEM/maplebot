...
exports.run = (client, message, args) => {
  var btcPrice = getJSON('https://maplechange.com/api/v2/tickers/xshbtc.json', function(error, response){
		if(!error) {
      ...
      const embed = new Discord.RichEmbed()
        ...
        .setDescription(":ledger: Maple Change XSH Market Data:")
        .setFooter(miscSettings.footerBranding, miscSettings.img32x32)
        .setThumbnail(miscSettings.imgXSH)
        /*
         * Takes a Date object, defaults to current date.
         */
        .setTimestamp()
        .setURL("https://github.com/TeamEGEM/maplebot")
        .addField("Website:", "https://www.shieldx.sh/")
