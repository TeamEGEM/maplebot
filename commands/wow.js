...
exports.run = (client, message, args) => {
  var btcPrice = getJSON('https://maplechange.com/api/v2/tickers/wowbtc.json', function(error, response){
		if(!error) {
      ...
      const embed = new Discord.RichEmbed()
        ...
        .setDescription(":ledger: Maple Change WOW Market Data:")
        .setFooter(miscSettings.footerBranding, miscSettings.img32x32)
        .setThumbnail(miscSettings.imgWOW)
        /*
         * Takes a Date object, defaults to current date.
         */
        .setTimestamp()
        .setURL("https://github.com/TeamEGEM/maplebot")
        .addField("Website:", "http://wownero.org/")
        ...
        .addField("Bitcoin Pair", "[BTC/WOW :scales:](https://maplechange.com/markets/wowbtc)", true)
        .addField("Litecoin Pair", "[LTC/WOW :scales:](https://maplechange.com/markets/wowltc)", true)
        .addField("Ethereum Pair", "[ETH/WOW :scales:](https://maplechange.com/markets/woweth)", true)
        .addField("WeyCoin Pair", "[WAE/WOW :scales:](https://maplechange.com/markets/wowwae)", true)
