...
exports.run = (client, message, args) => {
  var btcPrice = getJSON('https://api.coinmarketcap.com/v1/ticker/litecoin/', function(error, response){
		if(!error) {
      var ltcPrice = response[0]["price_usd"];
      ...
      const embed = new Discord.RichEmbed()
        ...
        .setDescription(":ledger: Maple Change LTC Market Data:")
        .setFooter(miscSettings.footerBranding, miscSettings.img32x32)
        .setThumbnail(miscSettings.imgLTC)
        /*
         * Takes a Date object, defaults to current date.
         */
        .setTimestamp()
        .setURL("https://github.com/TeamEGEM/maplebot")
        .addField("Website:", "https://litecoin.org/")
        .addField("Price", ltcPrice+" USD")
