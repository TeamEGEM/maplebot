...
exports.run = (client, message, args) => {
  var btcPrice = getJSON('https://maplechange.com/api/v2/tickers/irdbtc.json', function(error, response){
		if(!error) {
      ...
      const embed = new Discord.RichEmbed()
        ...
        .setDescription(":ledger: Maple Change IRD Market Data:")
        .setFooter(miscSettings.footerBranding, miscSettings.img32x32)
        .setThumbnail(miscSettings.imgIRD)
        /*
         * Takes a Date object, defaults to current date.
         */
        .setTimestamp()
        .setURL("https://github.com/TeamEGEM/maplebot")
        .addField("Website:", "https://ird.cash/")
        ...
        .addField("Bitcoin Pair", "[BTC/IRD :scales:](https://maplechange.com/markets/irdbtc)", true)
        .addField("Litecoin Pair", "[LTC/IRD :scales:](https://maplechange.com/markets/irdltc)", true)
        .addField("Ethereum Pair", "[ETH/IRD :scales:](https://maplechange.com/markets/irdeth)", true)
        .addField("WeyCoin Pair", "[WAE/IRD :scales:](https://maplechange.com/markets/irdwae)", true)
